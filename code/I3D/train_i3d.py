########################################################
# to train a different set, change:
#   train_split (line 204)
#   config_file (line 210. depending on number of classes)
########################################################
...
def run(configs,
    ...
    while steps < configs.max_steps and epoch < 400:  # for epoch in range(num_epochs):
        ...
        for phase in ['train', 'test']:
            ...
            #sandrine is changing the np.ints to just int
...
if __name__ == '__main__':
    ...
    # train_split = 'preprocess/nslt_2000.json # sandrine
    ...
    config_file = 'configfiles/asl10.ini'   # change here
